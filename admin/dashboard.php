        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="POST" class="d-flex" role="search">
                    <input class="form-control me-2" type="search" placeholder="Enter Recipt No" name="rid"
                        aria-label="Search" />
            ...
            <div class="col-sm-4">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <?php
$sql = "SELECT * FROM `info_visitor` WHERE `Status` IS NULL";
$result = mysqli_query($link, $sql);
            ...
            <div class="col-sm-4">
                <div class="card mt-3">
                    <div class="card-body">
                        ...
                        <p class="card-text">
                            <?php
$sql = "SELECT * FROM `info_visitor` WHERE `Status`= 1";
$result = mysqli_query($link, $sql);
